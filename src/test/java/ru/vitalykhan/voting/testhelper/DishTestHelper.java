...
public class DishTestHelper {
    ...
    public static final int DISH1_ID = START_SEQ + 16;
    public static final int DISH2_ID = START_SEQ + 17;
    public static final int DISH3_ID = START_SEQ + 18;
    public static final int DISH4_ID = START_SEQ + 19;
    public static final int DISH5_ID = START_SEQ + 20;
    public static final int DISH6_ID = START_SEQ + 21;
    public static final int DISH7_ID = START_SEQ + 22;
    public static final int DISH8_ID = START_SEQ + 23;
    public static final int DISH9_ID = START_SEQ + 24;
    public static final int DISH10_ID = START_SEQ + 25;
    public static final int DISH11_ID = START_SEQ + 26;
    public static final int DISH12_ID = START_SEQ + 27;
    public static final int DISH13_ID = START_SEQ + 28;
