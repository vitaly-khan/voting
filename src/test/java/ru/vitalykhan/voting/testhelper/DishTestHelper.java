...
public class DishTestHelper {
    ...
    public static final int DISH3_ID = START_SEQ + 20;
    public static final int DISH4_ID = START_SEQ + 21;
    public static final int DISH5_ID = START_SEQ + 22;
    public static final int DISH6_ID = START_SEQ + 23;
    public static final int DISH7_ID = START_SEQ + 24;
    public static final int DISH8_ID = START_SEQ + 25;
    public static final int DISH9_ID = START_SEQ + 26;
    public static final int DISH10_ID = START_SEQ + 27;
