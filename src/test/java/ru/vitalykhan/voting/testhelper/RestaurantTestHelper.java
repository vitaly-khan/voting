...
public class RestaurantTestHelper {
    ...
    public static final int DISABLED_RESTAURANT_ID = START_SEQ + 10;
    ...
    public static final Restaurant DISABLED_RESTAURANT = new Restaurant(DISABLED_RESTAURANT_ID, "Thai", false);
    ...
    public static final List<Restaurant> ALL_RESTAURANTS = List.of(
            RESTAURANT1, RESTAURANT2, RESTAURANT_WITH_NO_TODAYS_MENUS, RESTAURANT4, RESTAURANT5, DISABLED_RESTAURANT);
