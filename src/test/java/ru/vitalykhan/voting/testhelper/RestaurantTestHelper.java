...
public class RestaurantTestHelper {
    ...
    public static final Restaurant RESTAURANT4 = new Restaurant(RESTAURANT4_ID, "Disabled", false);

    public static final List<Restaurant> ENABLED_SORTED_RESTAURANTS = List.of(RESTAURANT3, RESTAURANT2, RESTAURANT1);
    public static final List<Restaurant> ALL_RESTAURANTS = List.of(RESTAURANT1, RESTAURANT2, RESTAURANT3, RESTAURANT4);
