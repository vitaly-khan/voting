...
public class VoteTestHelper {
    ...
    public static final int VOTE1_ID = START_SEQ + 32;
    public static final int VOTE2_ID = START_SEQ + 33;
    public static final int VOTE3_ID = START_SEQ + 34;
    public static final int VOTE4_ID = START_SEQ + 35;
    public static final int VOTE5_ID = START_SEQ + 36;
